...
export const REQUIRED_FIELDS = {
  ...
  OptionContract: ['option_ticker', 'underlying_symbol', 'expiration_date', 'strike', 'option_type', 'source'],
  ...
  DatasetSnapshot: ['dataset_id', 'asset_class', 'frequency', 'date_range', 'source_summary', 'coverage_summary', 'missingness_summary'],
  TrainingDataset: ['dataset_id', 'asset_class', 'feature_set_name', 'label_definition', 'split', 'created_at']
};
