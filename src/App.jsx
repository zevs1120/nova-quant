...
import { renderActiveScreen } from './app/screenRegistry.jsx';
...
export default function App() {
  ...
  const handleBrowseTopBarStateChange = (nextState) =>
  ...
  const screenContent = renderActiveScreen({
    ...
    browseSignals: finalUiData?.signals || [],
    setWatchlist,
    browseBackToken,
    onBrowseTopBarStateChange: handleBrowseTopBarStateChange,
    chatUserId,
    canUseInvestorDemo,
    clearInvestorDemo,
    handleLogout,
    ...
    renderMenuSectionArgs: {
      ...
      markWeeklyReviewed,
      investorDemoEnabled,
      investorDemoPerformance: INVESTOR_DEMO_PERFORMANCE,
      data,
      fetchJson,
      setUiMode,
      riskProfileKey,
