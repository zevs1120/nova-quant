...
const WORKFLOW_BLUEPRINTS = [
  {
    ...
    purpose:
      'Validate runtime data, feature parity, and freshness gates before next-day decisioning.',
  },
  {
...
export function buildDurableWorkflowSummary(repo: MarketRepository) {
  ...
  return {
    ...
    guarantees: {
      retry:
        'Workflow runs are designed to retry and record attempts instead of silently disappearing.',
