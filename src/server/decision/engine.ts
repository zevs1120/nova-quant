...
function buildNoActionCard(args: {
  ...
  return {
    ...
    governor: {
      ...
      proposed_trade_risk_pct: 0,
      exposure_snapshot: {
        total_exposure_pct: Number(args.portfolioContext.total_weight_pct || 0),
        same_symbol_pct: 0,
        sector_exposure_pct: 0,
        market_exposure_pct: Number(args.portfolioContext.total_weight_pct || 0),
        asset_class_exposure_pct: 0,
        same_direction_exposure_pct: 0,
      },
      realized_loss_windows: {
        ...
        max_realized_drawdown_pct: 0,
      },
      risk_budget_model: {
        exposure_cap_pct: Number(args.portfolioContext.total_weight_pct || 0),
        single_trade_risk_cap_pct: 0,
        position_cap_pct: 0,
        same_symbol_taper_pct: 0,
        same_symbol_cap_pct: 0,
        sector_cap_pct: 0,
        market_cap_pct: 0,
        asset_class_cap_pct: 0,
        same_direction_cap_pct: 0,
        daily_loss_limit_pct: 0,
        weekly_loss_limit_pct: 0,
        monthly_loss_limit_pct: 0,
        drawdown_caution_pct: 0,
        drawdown_derisk_pct: 0,
        drawdown_hard_stop_pct: 0,
        loss_streak_caution_count: 0,
        loss_streak_derisk_count: 0,
        loss_streak_block_count: 0,
        volatility_caution_percentile: 0,
        volatility_derisk_percentile: 0,
        volatility_black_swan_percentile: 0,
        risk_off_caution_threshold: 0,
        risk_off_derisk_threshold: 0,
        risk_off_black_swan_threshold: 0,
        suggested_time_stop_bars: 0,
      },
      execution_controls: {
        position_cap_pct: 0,
        suggested_time_stop_bars: 0,
        volatility_stop_pct: 0,
      },
    },
