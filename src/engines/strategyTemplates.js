...
const BUILTIN_STRATEGY_TEMPLATES = {
  ...
  EQ_VEL: {
    ...
    trigger_conditions: [
      ...
      { field: 'rsi_14', op: '<', value: 75, label: 'not_overbought' },
      { field: 'macd.above_zero', op: '==', value: true, label: 'macd_bullish' },
    ],
    invalidation: [
      { field: 'trend_strength', op: '<', value: 0.25, label: 'trend_collapsed' },
      { field: 'rsi_14', op: '>', value: 85, label: 'extreme_overbought' },
    ],
  ...
  EQ_EVT: {
    ...
    trigger_conditions: [
      ...
      { field: 'bollinger.width', op: '>', value: 0.02, label: 'band_widening' },
      { field: 'rsi_14', op: '<', value: 80, label: 'not_extreme' },
    ],
    invalidation: [
      { field: 'acceleration', op: '<', value: -0.5, label: 'gap_reversal' },
      { field: 'vol_percentile', op: '<', value: 0.3, label: 'vol_collapse' },
    ],
  ...
  EQ_REG: {
    ...
    trigger_conditions: [
      ...
      { field: 'trend_strength', op: '>=', value: 0.4, label: 'trend_minimum' },
      {
        ...
        op: 'in',
        value: ['BULL', 'WEAK_BULL', 'CONSOLIDATION'],
        label: 'ma_not_bearish',
      },
      { field: 'rsi_14', op: '>', value: 25, label: 'not_oversold' },
    ],
    invalidation: [{ field: 'risk_off_score', op: '>', value: 0.8, label: 'risk_off_extreme' }],
  ...
  EQ_SWING: {
    ...
    trigger_conditions: [
      ...
      { field: 'rsi_14', op: '<', value: 70, label: 'rsi_room' },
      { field: 'bias_rate_20', op: '<', value: 8, label: 'not_overextended' },
    ],
    invalidation: [
      { field: 'trend_strength', op: '<', value: 0.3, label: 'trend_failure' },
      { field: 'rsi_14', op: '>', value: 75, label: 'overbought_exit' },
    ],
  ...
  OP_INTRADAY: {
    ...
    trigger_conditions: [
      ...
      { field: 'rsi_6', op: '<', value: 80, label: 'rsi_room' },
    ],
    invalidation: [{ field: 'vol_percentile', op: '<', value: 0.2, label: 'iv_crush' }],
