...
import TodayClimateHeader from './today/TodayClimateHeader.jsx';
import TodayDeckSection from './today/TodayDeckSection.jsx';
import {
  fetchSignalDetail,
  ...
  return (
    ...
    >
      ...
      <TodayDeckSection
        ...
        onOpenSignalDetail={openSignalDetail}
        onSaveSignalToWatchlist={saveSignalToWatchlist}
        renderValidityPill={(signal) => <ActionCardValidityPill signal={signal} locale={locale} />}
        onCompleteUsageGuide={completeUsageGuide}
