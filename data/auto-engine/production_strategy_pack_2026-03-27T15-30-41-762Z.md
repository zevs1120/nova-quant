...
- Current blended target check: Sharpe 1.6283, annual 13.31%, max DD 3.92%.

B. Markets And Timeframes
- US: execution on 1d, holding window 18 bars max.
- CRYPTO: execution on 4h, holding window 58 bars max.
...
- US worst stress: slippage_plus_50 annual 0.97%, DD 0.66%. CRYPTO worst stress: slippage_plus_50 annual 15.99%, DD 4.14%.

J. Key Metrics
- Combined annual return: 13.31%
- Combined max drawdown: 3.92%
- Combined sharpe: 1.6283
