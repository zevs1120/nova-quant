...
export const pricingPlans = [
  {
    ...
    price: 'Free',
    cadence: '',
    blurb: 'Get the read before you decide to upgrade',
    features: [
      '3 Today cards per day',
      '3 Ask Nova questions per day',
      'full Browse access',
    ],
    cta: 'Start free',
    tone: 'mint',
  },
  {
    ...
    price: '$19',
    cadence: '/ week',
    blurb: 'Built for daily use',
    features: [
      'full Today flow',
      '20 Ask Nova questions per day',
      'broker handoff',
    ],
    cta: 'Choose Lite',
    tone: 'blue',
  },
  {
    ...
    price: '$29',
    cadence: '/ week',
    blurb: 'The deeper AI layer',
    features: [
      'everything in Lite',
      'portfolio-aware Ask Nova',
      'deeper risk and weekly context',
    ],
    cta: 'Choose Pro',
    tone: 'pink',
  },
