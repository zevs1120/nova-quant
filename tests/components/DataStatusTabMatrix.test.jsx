...
import Component from '../../src/components/DataStatusTab';
...
describe('DataStatusTab UI Matrix Tests', () => {
  ...
  it.each(permutations)('Safely mounts DataStatusTab under configuration %#', (props) => {
