...
import Component from '../../src/components/SignalsTab';
...
describe('SignalsTab UI Matrix Tests', () => {
  ...
  it.each(permutations)('Safely mounts SignalsTab under configuration %#', (props) => {
