...
import Component from '../../src/components/ResearchTab';
...
describe('ResearchTab UI Matrix Tests', () => {
  ...
  it.each(permutations)('Safely mounts ResearchTab under configuration %#', (props) => {
