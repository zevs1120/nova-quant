...
import Component from '../../src/components/MembershipSheet';
...
describe('MembershipSheet UI Matrix Tests', () => {
  ...
  it.each(permutations)('Safely mounts MembershipSheet under configuration %#', (props) => {
